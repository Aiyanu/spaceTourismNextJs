  ...
  return (
    <main className=" flex lg:flex-row flex-col justify-center pt-10 lg:pt-0 lg:justify-around items-center h-screen bg-no-repeat bg-cover">
      ...
      <div className="w-[450px] h-[380px] scale-75 lg:scale-100">
        ...
        <h1 className={`${bellefair.className} text-[150px] text-third`}>
          SPACE
        </h1>
      ...
      <Link
        href="/destination"
        className={`lg:scale-100 bg-white text-[32px] uppercase rounded-full py-24 px-24 text-2xl font-bold ${bellefair.className} h-16 w-16 flex items-center justify-center transition-all duration-300 outline-none hover:outline-[rgba(255,255,255,0.4)] outline-[30px] border-[rgba(255,255,255,0.4)]`}
      >
        Explore
      </Link>
    </main>
